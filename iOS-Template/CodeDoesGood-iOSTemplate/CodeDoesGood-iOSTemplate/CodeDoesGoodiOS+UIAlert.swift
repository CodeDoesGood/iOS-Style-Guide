...
extension UIAlertController {
    func featureNotImplementedAlert() {
        let alert = UIAlertController(title: "This feature is not yet implemented",
                                      message: nil,
                                      preferredStyle: .alert)
        let okayAction = UIAlertAction(title: Constants.Alerts().okay, style: .cancel, handler: nil)
        alert.addAction(okayAction)
        self.present(alert, animated: true, completion: nil)
    }

    func customUIAlert(title: String,
                       message: String,
                       buttonName: String?,
        ...
        let customButtonAction = UIAlertAction(title: buttonName,
                                               style: .default,
                                               handler: action as? (UIAlertAction) -> Void)
